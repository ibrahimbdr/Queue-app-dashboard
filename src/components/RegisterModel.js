...
const RegisterModel = ({ title, setRegisterModel, registerModel }) => {
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          <h2 className="mt-3">New {title} has been registered</h2>

          <button
            onClick={() => setRegisterModel(false)}
            className="text-xl mt-3 border border-gray-500 hover:bg-gray-500 hover:text-white mx-5 w-32 text-center rounded  py-2 transition-all"
          >
            Close
          </button>
        </div>
